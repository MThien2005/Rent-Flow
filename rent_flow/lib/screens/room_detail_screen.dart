...
class _RoomDetailScreenState extends State<RoomDetailScreen>{
            ...
            body: SingleChildScrollView(
                ...
                child: Column(
                    ...
                    children: [
                        ...
                        if(widget.room.isRented && hasContract && currentRenter != null) ...[
                            const Text(
            ...
            child: Row(
                children: [
                    Container(
                        ...
                        decoration: BoxDecoration(
                            color: isRented ? Colors.white.withValues(alpha: 0.1) : Colors.green.shade50,
                    ...
                    Column(
                        ...
                        children: [
                            Text(
                                'Trạng Thái',
                                style: TextStyle(color: isRented ? Colors.white70 : Colors.grey.shade600, fontSize: 14),
                            ),
                            const SizedBox(height: 4,),
                            Text(
  ...
  Widget _buildInfoSection() {
    return Container(
      ...
      child: Column(
        children: [
          _buildInfoRow(Icons.payments_outlined, 'Giá thuê', '${widget.room.price} Tr / tháng'),
        ],
      ),
    );
  }
  ...
  Widget _buildUtilitySection() {
    return Container(
      ...
      child: Column(
        children: [
          _buildInfoRow(Icons.bolt_outlined, 'Số điện cũ', '${widget.room.lastElectricIndex} kWh', hasDivider: true),
          _buildInfoRow(Icons.water_drop_outlined, 'Số nước cũ', '${widget.room.lastWaterIndex} m³'),
        ],
      ),
    );
  }

  Widget _buildInfoRow(IconData icon, String title, String value, {bool hasDivider = false}) {
    return Column(
      children: [
        Padding(
